...
/**
 * Spring Security {@link WithSecurityContextFactory} backing
 * {@link WithMockJwtUser}. Builds a {@link UsernamePasswordAuthenticationToken}
 * with the requested roles, mirroring what the production
 * {@code JwtAuthenticationFilter} would have produced.
 */
public class WithMockJwtUserSecurityContextFactory
    ...
    public SecurityContext createSecurityContext(WithMockJwtUser ann) {
        ...
        List<GrantedAuthority> authorities = Arrays.stream(ann.roles())
