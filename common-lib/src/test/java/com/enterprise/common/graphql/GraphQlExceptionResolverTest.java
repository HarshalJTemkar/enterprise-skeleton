...
class GraphQlExceptionResolverTest {
    ...
    void setUp() {
        ...
        when(messages.getOrDefault(Mockito.anyString(), Mockito.anyString(), Mockito.any(Object[].class)))
                .thenAnswer(inv -> inv.getArgument(1));
        resolver = new GraphQlExceptionResolver(messages, new GraphQlProperties());

        env = DataFetchingEnvironmentImpl
                .newDataFetchingEnvironment()
                .executionStepInfo(graphql.execution.ExecutionStepInfo.newExecutionStepInfo()
    ...
    void unknown_exception_maps_to_internal_error_without_leaking_message() {
        ...
        var strictResolver = new GraphQlExceptionResolver(
