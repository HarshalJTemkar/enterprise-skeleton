 ...
 *
 * <ul>
 *   <li>Uses the locale from {@link LocaleContextHolder} (set by {@code
 *       AcceptHeaderLocaleResolver}) when none is provided.
 *   <li>Never throws — returns the key itself if the translation is missing.
 * </ul>
 *
 * <p>Injected anywhere a message has to be rendered (exception handler, email templates, API
 * warnings, etc.).
 */
