...
/**
 * Binds {@code enterprise.common.i18n.*}. Drives {@code MessageSource} +
 * {@code LocaleResolver} registration.
 */
...
public class I18nProperties {
    ...
    public void setBasenames(List<String> v) { this.basenames = v; }
    ...
    public void setCacheDuration(Duration v) { this.cacheDuration = v; }
    ...
    public void setUseCodeAsDefaultMessage(boolean v) { this.useCodeAsDefaultMessage = v; }
}
