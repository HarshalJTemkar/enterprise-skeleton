...
/**
 * Binds {@code enterprise.common.async.*}. Controls both the primary
 * {@code @Async} executor and the dedicated parallel executor used by
...
public class AsyncProperties {
    ...
    /**
     * When {@code true}, uses JDK 21 virtual threads for {@code @Async}
     * (unbounded, cheap). When {@code false} a platform-thread pool is used
     * with the {@code core/max/queue} sizes below.
     */
