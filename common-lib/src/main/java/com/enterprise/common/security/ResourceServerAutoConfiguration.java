 ...
 *
 * <ul>
 *   <li>{@link JwtAuthenticationFilter} – validates the bearer token and populates the security
 *       context.
 *   <li>{@link ProblemDetailAuthenticationEntryPoint} – emits RFC 7807 responses for 401 / 403.
 * </ul>
 *
 * <p>The shared filter chain still lives in each service so they can decide which routes to
 * protect. Toggle with {@code enterprise.common.security.resource-server.enabled=true}.
 */
@Configuration
@ConditionalOnClass(name = "org.springframework.security.web.SecurityFilterChain")
@ConditionalOnProperty(
    prefix = "enterprise.common.security.resource-server",
    name = "enabled",
    havingValue = "true",
...
public class ResourceServerAutoConfiguration {
  ...
  public JwtAuthenticationFilter jwtAuthenticationFilter(
      JwtTokenProvider provider, CommonProperties props) {
