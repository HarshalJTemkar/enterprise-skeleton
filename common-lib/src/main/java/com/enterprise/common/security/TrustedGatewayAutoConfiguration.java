...
/**
 * Registers {@link TrustedGatewayHeaderFilter} as a servlet filter when
 * {@code enterprise.common.security.trusted-gateway.enabled=true}. The
 * filter rejects requests that don't carry the configured shared secret
 * header — preventing direct access that bypasses the API gateway and
 * blocking spoofed {@code X-Auth-*} identity headers.
 *
 * <p>Configuration:</p>
 * <pre>
 * enterprise:
...
@ConditionalOnProperty(prefix = "enterprise.common.security.trusted-gateway",
...
public class TrustedGatewayAutoConfiguration {
    ...
    public static class TrustedGatewayProperties {
        ...
        public java.util.List<String> getUrlPatterns() { return urlPatterns; }
        public void setUrlPatterns(java.util.List<String> v) { this.urlPatterns = v; }
    }
}
