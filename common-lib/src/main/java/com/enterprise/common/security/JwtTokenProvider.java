...
/**
 * Small, self-contained JWT helper. Registered as a {@code @Bean} by the platform's
 * auto-configuration when JJWT is on the classpath and {@code
 * enterprise.common.security.enabled=true}.
 */
