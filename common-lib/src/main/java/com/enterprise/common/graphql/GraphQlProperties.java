...
public class GraphQlProperties {
    ...
    /**
     * Reject queries whose computed complexity score exceeds this threshold.
     * Each field counts as 1 by default. {@code -1} disables.
     */
    ...
    public int getMaxQueryDepth() { return maxQueryDepth; }
    public void setMaxQueryDepth(int v) { this.maxQueryDepth = v; }

    public int getMaxQueryComplexity() { return maxQueryComplexity; }
    public void setMaxQueryComplexity(int v) { this.maxQueryComplexity = v; }

    public Introspection getIntrospection() { return introspection; }
    public Scalars getScalars() { return scalars; }
    public ErrorMapping getErrorMapping() { return errorMapping; }
    ...
    public static class ErrorMapping {
        ...
        public boolean isEnabled() { return enabled; }
        public void setEnabled(boolean v) { this.enabled = v; }
        public boolean isExposeMessage() { return exposeMessage; }
        public void setExposeMessage(boolean v) { this.exposeMessage = v; }
    }
}
