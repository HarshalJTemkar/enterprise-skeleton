...
/**
 * Generic contract every entity↔DTO mapper should extend. It gives you {@code toDto / toEntity}
 * plus bulk list/set variants for free — MapStruct generates their implementations from the
...
public interface BaseMapper<E, D> {
  ...
  /**
   * Convert a collection of entities to a list of DTOs. Default implementation delegates to {@link
   * #toDto(Object)} to avoid generating a second MapStruct method.
   */
  ...
  /**
   * Convert a collection of entities to a {@link Set} of DTOs (useful for JPA relationship
   * mapping).
   */
