 ...
 *
 * <p>All fields are overridable under the {@code enterprise.common.openapi.*}
 * prefix in {@code application.yml}. Setting {@link #enabled} to {@code false}
 * completely disables the OpenAPI bean registration.</p>
 */
...
public class OpenApiProperties {
    ...
    public boolean isJwtSecurityEnabled() { return jwtSecurityEnabled; }
    public void setJwtSecurityEnabled(boolean jwtSecurityEnabled) { this.jwtSecurityEnabled = jwtSecurityEnabled; }
    public String getSecuritySchemeName() { return securitySchemeName; }
    public void setSecuritySchemeName(String securitySchemeName) { this.securitySchemeName = securitySchemeName; }
}
