...
/**
 * Thrown when an optimistic-locking failure or pessimistic-lock acquisition failure is detected.
 * Maps to HTTP 409 via {@link ErrorCode#OPTIMISTIC_LOCK} by default.
 */
