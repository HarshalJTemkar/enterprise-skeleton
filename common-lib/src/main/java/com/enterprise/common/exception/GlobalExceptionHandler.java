...
/**
 * Global REST exception handler that returns RFC 7807 {@link ProblemDetail}
 * documents with an embedded {@link ErrorResponse} envelope.
 *
 * <p>Handlers are ordered from most-specific to most-generic. Spring picks
 * the closest match by parameter type, so the catch-all {@link Exception}
 * handler only fires for genuinely unexpected errors.</p>
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleBase(BaseException ex, HttpServletRequest req) {
        ...
        String localized = messageService.getOrDefault(
                ex.getMessageKey(), ex.getMessage(), ex.getMessageArgs());
    ...
    public ResponseEntity<ProblemDetail> handleMethodArgNotValid(
        ...
        List<ValidationException.FieldViolation> violations = ex.getBindingResult().getFieldErrors().stream()
                .map(fe -> new ValidationException.FieldViolation(
    ...
    public ResponseEntity<ProblemDetail> handleConstraint(
        ...
        List<ValidationException.FieldViolation> violations = ex.getConstraintViolations().stream()
                .map(cv -> new ValidationException.FieldViolation(
    ...
    public ResponseEntity<ProblemDetail> handleMissingParam(
        ...
        return build(HttpStatus.BAD_REQUEST, ErrorCode.MISSING_PARAMETER,
                ...
                req, List.of(), Map.of("parameter", ex.getParameterName()), ex);
    }
    ...
    public ResponseEntity<ProblemDetail> handleMissingHeader(
        ...
        return build(HttpStatus.BAD_REQUEST, ErrorCode.MISSING_HEADER,
                ...
                req, List.of(), Map.of("header", ex.getHeaderName()), ex);
    }
    ...
    public ResponseEntity<ProblemDetail> handleMissingPathVar(
        ...
        return build(HttpStatus.BAD_REQUEST, ErrorCode.BAD_REQUEST,
                ...
                req, List.of(), Map.of("variable", ex.getVariableName()), ex);
    }
    ...
    public ResponseEntity<ProblemDetail> handleBindingException(
        ...
        return build(HttpStatus.BAD_REQUEST, ErrorCode.BAD_REQUEST,
                ex.getMessage(), req, List.of(), Map.of(), ex);
    }
    ...
    public ResponseEntity<ProblemDetail> handleUnsupportedMediaType(
        ...
        return build(HttpStatus.UNSUPPORTED_MEDIA_TYPE, ErrorCode.UNSUPPORTED_MEDIA_TYPE,
                ...
                req, List.of(),
                Map.of("contentType", String.valueOf(ex.getContentType())), ex);
    }
    ...
    public ResponseEntity<ProblemDetail> handleNotAcceptable(
        ...
        return build(HttpStatus.NOT_ACCEPTABLE, ErrorCode.NOT_ACCEPTABLE,
    ...
    public ResponseEntity<ProblemDetail> handleMaxUpload(
        ...
        return build(HttpStatus.PAYLOAD_TOO_LARGE, ErrorCode.PAYLOAD_TOO_LARGE,
                ...
                req, List.of(),
                Map.of("maxBytes", ex.getMaxUploadSize()), ex);
    }
    ...
    public ResponseEntity<ProblemDetail> handleMultipart(
        ...
        return build(HttpStatus.BAD_REQUEST, ErrorCode.BAD_REQUEST,
                "Malformed multipart request", req, List.of(), Map.of(), ex);
    }

    @ExceptionHandler(AsyncRequestTimeoutException.class)
    public ResponseEntity<ProblemDetail> handleAsyncTimeout(
            AsyncRequestTimeoutException ex, HttpServletRequest req) {
        return build(HttpStatus.SERVICE_UNAVAILABLE, ErrorCode.INTEGRATION_TIMEOUT,
                "Async request timed out", req, List.of(), Map.of(), ex);
    }
    ...
    public ResponseEntity<ProblemDetail> handleLocked(LockedException ex, HttpServletRequest req) {
        return build(HttpStatus.LOCKED, ErrorCode.ACCOUNT_LOCKED,
    ...
    public ResponseEntity<ProblemDetail> handleAccountExpired(
        ...
        return build(HttpStatus.FORBIDDEN, ErrorCode.ACCOUNT_EXPIRED,
    ...
    public ResponseEntity<ProblemDetail> handleCredentialsExpired(
        ...
        return build(HttpStatus.FORBIDDEN, ErrorCode.CREDENTIALS_EXPIRED,
    ...
    public ResponseEntity<ProblemDetail> handleExpiredJwt(
        ...
        return build(HttpStatus.UNAUTHORIZED, ErrorCode.TOKEN_EXPIRED,
    ...
    public ResponseEntity<ProblemDetail> handleInvalidJwt(JwtException ex, HttpServletRequest req) {
        return build(HttpStatus.UNAUTHORIZED, ErrorCode.TOKEN_INVALID,
    ...
    /**
     * Duplicate keys / FK / NOT NULL constraint failures. We attempt to
     * surface the constraint name to help operators map the issue.
     */
    @ExceptionHandler({DataIntegrityViolationException.class, DuplicateKeyException.class,
            SQLIntegrityConstraintViolationException.class})
    public ResponseEntity<ProblemDetail> handleIntegrity(Exception ex, HttpServletRequest req) {
        ErrorCode code = (ex instanceof DuplicateKeyException)
        ...
        return build(code.getHttpStatus(), code,
                messageService.get(code.getMessageKey()),
                req, List.of(), details, ex);
    }

    @ExceptionHandler(OptimisticLockingFailureException.class)
    public ResponseEntity<ProblemDetail> handleOptimisticLock(
            OptimisticLockingFailureException ex, HttpServletRequest req) {
        return build(HttpStatus.CONFLICT, ErrorCode.OPTIMISTIC_LOCK,
    ...
    public ResponseEntity<ProblemDetail> handleLock(Exception ex, HttpServletRequest req) {
        return build(HttpStatus.LOCKED, ErrorCode.RESOURCE_LOCKED,
    ...
    public ResponseEntity<ProblemDetail> handleQueryTimeout(
        ...
        return build(HttpStatus.GATEWAY_TIMEOUT, ErrorCode.DATABASE_TIMEOUT,
    ...
    public ResponseEntity<ProblemDetail> handleDbDown(
        ...
        return build(HttpStatus.SERVICE_UNAVAILABLE, ErrorCode.DATABASE_UNAVAILABLE,
    ...
    public ResponseEntity<ProblemDetail> handleDataAccess(
        ...
        return build(HttpStatus.INTERNAL_SERVER_ERROR, ErrorCode.DATABASE_ERROR,
    ...
    public ResponseEntity<ProblemDetail> handleSql(SQLException ex, HttpServletRequest req) {
        ...
        return build(HttpStatus.INTERNAL_SERVER_ERROR, ErrorCode.DATABASE_ERROR,
                messageService.get(ErrorCode.DATABASE_ERROR.getMessageKey()),
                req, List.of(),
                Map.of("sqlState", String.valueOf(ex.getSQLState())), ex);
    }
    ...
    public ResponseEntity<ProblemDetail> handleUnsupported(
        ...
        return build(HttpStatus.NOT_IMPLEMENTED, ErrorCode.NOT_IMPLEMENTED,
    ...
    public ResponseEntity<ProblemDetail> handleTimeout(
        ...
        return build(HttpStatus.GATEWAY_TIMEOUT, ErrorCode.INTEGRATION_TIMEOUT,
    ...
    /**
     * Builds the final {@link ProblemDetail} response with the correlation-id
     * header and the {@link ErrorResponse} envelope attached under {@code "error"}.
     */
    static ResponseEntity<ProblemDetail> buildResponse(HttpStatus status, ErrorCode code,
        ...
        ErrorResponse envelope = new ErrorResponse(
                code.getCode(), message, correlationId, Instant.now(),
                path, fieldErrors == null ? List.of() : fieldErrors, details);
    ...
    private ResponseEntity<ProblemDetail> build(HttpStatus status, ErrorCode code,
                                                String message, HttpServletRequest req,
                                                List<ValidationException.FieldViolation> fieldErrors,
                                                Map<String, Object> details,
                                                Exception ex) {
