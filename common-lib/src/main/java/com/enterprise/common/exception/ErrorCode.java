 ...
 * <ul>
 *   <li>a stable machine-readable code (exposed to clients)</li>
 *   <li>a default message-bundle key (resolved via {@code MessageService})</li>
 *   <li>an HTTP status to emit when the exception bubbles up</li>
 * </ul>
 *
 * <p>Keep codes immutable once released; add new ones rather than renumbering.</p>
 */
public enum ErrorCode {
    ...
    UNSUPPORTED_MEDIA_TYPE("ERR-0007", "error.unsupported.media.type", HttpStatus.UNSUPPORTED_MEDIA_TYPE),
    ...
    INTEGRATION_UNAVAILABLE("ERR-3003", "error.integration.unavailable", HttpStatus.SERVICE_UNAVAILABLE),
