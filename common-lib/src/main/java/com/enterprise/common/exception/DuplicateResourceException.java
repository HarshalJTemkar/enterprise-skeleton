...
/**
 * Thrown when an attempt is made to create a resource whose unique identifier (or business key)
 * already exists. Maps to HTTP 409 via {@link ErrorCode#DUPLICATE_RESOURCE}.
 */
