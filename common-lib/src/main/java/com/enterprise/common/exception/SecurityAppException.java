...
/**
 * Thrown for authentication / authorization failures originating from
 * application code. Named {@code SecurityAppException} to avoid clashing
 * with {@code java.lang.SecurityException}.
 */
public class SecurityAppException extends BaseException {
    ...
    public static SecurityAppException invalidCredentials() {
        return new SecurityAppException(ErrorCode.INVALID_CREDENTIALS,
