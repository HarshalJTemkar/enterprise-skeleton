 ...
 *
 * <p>Every custom exception thrown by a service should extend this class (or one of its direct
 * children) so the {@code GlobalExceptionHandler} can:
 *
 * <ul>
 *   <li>Map to the right HTTP status via {@link ErrorCode}.
 *   <li>Resolve the localized message via the {@link #getMessageKey()}.
 *   <li>Pass structured {@link #getDetails() details} through to the client.
 * </ul>
 */
