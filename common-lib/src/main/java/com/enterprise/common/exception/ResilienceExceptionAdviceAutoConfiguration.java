...
/**
 * Registers the {@link ResilienceExceptionAdvice} only when Resilience4j is
 * on the classpath. Keeping it conditional means {@code common-lib} can be
 * consumed by services that don't use Resilience4j without classloader
 * issues at startup.
 */
@AutoConfiguration
