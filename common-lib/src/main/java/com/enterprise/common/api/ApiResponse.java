 ...
 * }</pre>
 *
 * <p>Failures are <em>not</em> wrapped in {@code ApiResponse} — they are
 * emitted as RFC 7807 {@link org.springframework.http.ProblemDetail}
 * documents with an {@link ErrorResponse} envelope by
