...
/**
 * Binds {@code enterprise.common.scheduler.*}. Controls the shared {@link
 * org.springframework.scheduling.TaskScheduler} used for {@code @Scheduled} methods.
 */
...
public class SchedulerProperties {
  ...
  /**
   * Use virtual threads (JDK 21) for scheduled task execution. Virtual threads are a good fit here
   * because scheduled jobs are usually I/O bound and infrequent.
   */
  ...
  public void setAwaitTerminationSeconds(int v) {
    this.awaitTerminationSeconds = v;
  }
}
