 ...
 *
 * <ol>
 *   <li>captures arguments (optionally) before the call
 *   <li>invokes the target
 *   <li>captures the return value (optionally)
 *   <li>builds an {@link AuditEvent} and pushes it through the {@link AuditEventPublisher}
 *   <li>re-throws any exception after emitting a failure event
 * </ol>
 */
@Aspect
