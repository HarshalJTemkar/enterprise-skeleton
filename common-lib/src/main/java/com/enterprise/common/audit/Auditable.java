...
/**
 * Marks a service method as audit-worthy. An AOP aspect captures the call before/after the
 * invocation, builds an {@link AuditEvent}, and forwards it to the {@link AuditEventPublisher}.
 *
 * <p>Example:
 *
 * <pre>{@code
