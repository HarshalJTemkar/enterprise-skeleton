...
/**
 * Resolves the "current actor" used by Spring Data JPA auditing to populate
 * {@code @CreatedBy / @LastModifiedBy} fields on {@code BaseEntity}.
 *
 * <p>Order of resolution:</p>
 * <ol>
 *   <li>The authenticated principal name from {@link SecurityContextHelper}</li>
 *   <li>{@code "system"} — used by background jobs and tests</li>
 * </ol>
 */
