...
public final class StringUtils {
  ...
  /**
   * Mask all but the last {@code visible} characters of a string, useful for displaying card
   * numbers or emails: {@code mask("alice@x", 3)} → {@code ****@x}.
   */
  ...
  /**
   * Produce a URL-safe slug: lower-cased, diacritics stripped, spaces become hyphens,
