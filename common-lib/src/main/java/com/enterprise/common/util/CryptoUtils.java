 ...
 *
 * <ul>
 *   <li>AES-GCM symmetric encryption / decryption with random IVs
 *   <li>HMAC-SHA256 signing
 *   <li>URL-safe Base64 encoding / decoding
 * </ul>
 *
 * <p>All methods use {@link java.security.SecureRandom}; keys must be supplied by the caller — this
 * class is deliberately not Spring-managed so it can be reused from plain JVM processes too.
 */
public final class CryptoUtils {
  ...
  /**
   * AES-GCM encrypt {@code plaintext}. The first 12 bytes of the returned array are the random IV;
