...
/**
 * Thin wrapper around a shared {@link ObjectMapper} configured for the
 * platform (Java Time enabled, unknown properties tolerated, ISO instants).
 *
 * <p>Methods never throw – {@code null} / {@link Optional} is returned on
 * failure and the caller can decide whether to escalate.</p>
 */
public final class JsonUtils {
    ...
    public static <T> Optional<T> fromJson(String json, Class<T> type) {
        ...
        try { return Optional.ofNullable(MAPPER.readValue(json, type)); }
