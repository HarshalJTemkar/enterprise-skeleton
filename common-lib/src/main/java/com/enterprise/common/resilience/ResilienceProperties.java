 ...
 *
 * <p>These values feed a programmatically created {@code "default"} {@link
 * io.github.resilience4j.circuitbreaker.CircuitBreaker}, {@link
 * io.github.resilience4j.ratelimiter.RateLimiter}, {@link
 * io.github.resilience4j.timelimiter.TimeLimiter}, {@link io.github.resilience4j.retry.Retry} and
 * {@link io.github.resilience4j.bulkhead.Bulkhead} instance, so services can start annotating
 * methods with {@code @CircuitBreaker(name = "default") / @RateLimiter(name = "default")} etc.
 * without any extra YAML. You can still override per-instance via the native {@code resilience4j.*}
 * property tree.
 */
...
public class ResilienceProperties {
  ...
  public static class CircuitBreaker {
    ...
    public void setSlowCallRateThreshold(float v) {
      this.slowCallRateThreshold = v;
    }
    ...
    public void setSlowCallDurationThreshold(Duration v) {
      this.slowCallDurationThreshold = v;
    }
  ...
  public static class RateLimiter {
    ...
    public void setLimitForPeriod(int v) {
    ...
    public void setLimitRefreshPeriod(Duration v) {
      this.limitRefreshPeriod = v;
    }
    ...
    public void setTimeoutDuration(Duration v) {
      this.timeoutDuration = v;
    }
  }
  ...
  public static class TimeLimiter {
    ...
    public void setCancelRunningFuture(boolean v) {
      this.cancelRunningFuture = v;
    }
  }
  ...
  public static class Retry {
    ...
    public void setExponentialBackoffMultiplier(double v) {
      this.exponentialBackoffMultiplier = v;
    }
  }
  ...
  public static class Bulkhead {
    ...
    public void setMaxConcurrentCalls(int v) {
    ...
    public void setMaxWaitDuration(Duration v) {
      this.maxWaitDuration = v;
    }
  }
}
