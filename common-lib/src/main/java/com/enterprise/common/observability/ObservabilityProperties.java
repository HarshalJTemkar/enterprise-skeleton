 ...
 *
 * <p>Tracing-related toggles. The Spring Boot 3 starter for {@code micrometer-tracing-bridge-otel}
 * reads {@code management.tracing.*} natively; we add a thin layer on top so the platform can flip
 * the whole stack with one switch and so the OTLP endpoint surfaces in {@code /actuator/info}.
 */
...
public class ObservabilityProperties {
  ...
  public static class Tracing {
    ...
    public void setSamplingProbability(double v) {
      this.samplingProbability = v;
    }
