...
/**
 * Marker subclass of {@link BaseEntity} for aggregates whose lifecycle you
 * want to audit via {@link AppStatus} in addition to the standard timestamps.
 * Add further audit columns here if needed (e.g. approvedBy, archivedAt).
 */
@MappedSuperclass
