...
/**
 * Binds {@code enterprise.common.logging.*}. Drives the correlation-id filter and the
 * request/response logging filter including body masking.
 */
...
public class LoggingProperties {
  ...
  public static class CorrelationId {
    ...
    public void setGenerateRequestId(boolean v) {
      this.generateRequestId = v;
    }
  }
  ...
  public static class AccessLog {
    ...
    private List<String> excludePatterns =
        List.of("/actuator/**", "/favicon.ico", "/v3/api-docs/**", "/swagger-ui/**");
    ...
    public void setIncludePayload(boolean v) {
    ...
    public void setMaxPayloadLength(int v) {
    ...
    public void setExcludePatterns(List<String> v) {
      this.excludePatterns = v;
    }
  }
  ...
  public static class Masking {
    ...
    /**
     * JSON field names whose <em>values</em> are replaced with {@code ***} in logs
     * (case-insensitive).
     */
