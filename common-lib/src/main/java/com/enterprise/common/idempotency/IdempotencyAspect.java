 ...
 * <ol>
 *   <li>Read the {@code Idempotency-Key} header from the current request.</li>
 *   <li>If the key already exists in the {@link IdempotencyStore} return the
 *       cached response immediately (no re-execution).</li>
 *   <li>Otherwise proceed, serialize the response and cache it under the key.</li>
 * </ol>
 */
@Aspect
