...
/**
 * Lifecycle status common to most aggregates in the platform. Prefer this over ad-hoc boolean
 * {@code active}/{@code deleted} fields so filters and reports remain uniform across services.
 */
