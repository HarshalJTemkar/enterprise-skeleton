...
/**
 * End-to-end test of the {@code /demo/mapper} endpoint. Demonstrates the use
 * of the shared {@link WithMockJwtUser} fixture from {@code common-lib}.
 */
@SpringBootTest
@ActiveProfiles("test")
class DemoControllerTest {
    ...
    @Test
    @WithMockJwtUser(username = "alice", roles = {"USER"})
    void mapperReturnsDtoWithoutPasswordHash() throws Exception {
        mockMvc.perform(get("/demo/mapper"))
