 ...
 *
 * <p>Inheriting {@link BaseMapper} gives you {@code toDto / toEntity} plus
 * collection helpers automatically. MapStruct generates the implementation at
 * compile time.</p>
 */
...
public interface UserMapper extends BaseMapper<UserEntity, UserDto> {
    ...
    /**
     * DTO → Entity. {@code passwordHash} must be supplied elsewhere (e.g. a
     * service layer) because the DTO does not expose it.
     */
    @Override
