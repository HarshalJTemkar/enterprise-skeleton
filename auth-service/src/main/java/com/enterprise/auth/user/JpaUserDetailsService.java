...
/**
 * JPA-backed {@link UserDetailsService} consumed by Spring Security's
 * {@code DaoAuthenticationProvider}.
 *
 * <p>Replaces the in-memory user list previously kept in {@code application.yml}.
 * Roles are mapped to {@code ROLE_*} authorities so {@code hasRole("ADMIN")}
 * works as expected.</p>
 */
@Service
